...
public class InstructorLectureDto {
    ...
    public static InstructorLectureDto fromEntity(Lecture lecture) {
        return InstructorLectureDto.builder()
                ...
                .courseTitle(lecture.getCourse() != null ? lecture.getCourse().getTitle() : null)
                .instructorName(lecture.getCourse() != null && lecture.getCourse().getCreatedBy() != null
                        ? lecture.getCourse().getCreatedBy().getName()
                        : null)
