            ...
            <div className="container mx-auto flex h-16 items-center justify-between px-6">
                ...
                <div className="flex items-center gap-8">
                    ...
                    <Menubar className="border-none shadow-none bg-transparent p-0">
                        <MenubarMenu>
                            <MenubarTrigger className="cursor-pointer font-bold text-gray-700 hover:text-primary data-[state=open]:bg-transparent focus:bg-transparent">강좌·강의</MenubarTrigger>
                        ...
                        <MenubarMenu>
                            <MenubarTrigger className="cursor-pointer font-bold text-gray-700 hover:text-primary data-[state=open]:bg-transparent focus:bg-transparent">회원관리</MenubarTrigger>
                            <MenubarContent className="bg-white border-border rounded-none shadow-lg">
                                ...
                                <MenubarItem className="focus:bg-gray-50 focus:text-primary rounded-none cursor-pointer" onClick={() => { navigate('/admin/users/students') }}>학생 관리</MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                        <MenubarMenu>
                            ...
                            <MenubarContent className="bg-white border-border rounded-none shadow-lg">
                                <MenubarItem className="focus:bg-gray-50 focus:text-primary rounded-none cursor-pointer" onClick={() => { navigate('/admin/problems') }}>코딩테스트</MenubarItem>
